...
fn main() {
    ...
    let mut dp = vec![vec![0; max_weight+1]; real_thing_count+1];
    for i in 1..=real_thing_count {
    ...
    println!("{}", dp[real_thing_count][max_weight]);
}
